 ...
 <Worksheet ss:Name="Sheet1">
  <Table ss:ExpandedColumnCount="10" ss:ExpandedRowCount="25" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0" ss:Height="40.5">
    <Cell ss:MergeAcross="9" ss:StyleID="s66"><Data ss:Type="String"> 发放记录</Data></Cell>
   </Row>
   <Row ss:AutoFitHeight="0" ss:Height="41.25">
    ...
    <Cell ss:StyleID="s63"><Data ss:Type="String">发放次数</Data></Cell>
    <Cell ss:StyleID="s63"><Data ss:Type="String">发放量</Data></Cell>    
   </Row>
   <#list trades as obj>
   <Row ss:AutoFitHeight="0" ss:Height="24">
    <Cell ss:StyleID="s64"><Data ss:Type="String">${obj.providedate}</Data></Cell>
    <Cell ss:StyleID="s64"><Data ss:Type="String">${obj.providetime}</Data></Cell>
    ...
    <Cell ss:StyleID="s64"><Data ss:Type="String">${obj.guidelinecount}</Data></Cell>
   </Row>
   </#list>   
  </Table>
