...
$(document).ready(function(){        
    $('.icheck').iCheck({
    	...
    	$('#trades tr').attr('align','center');
      	...
      	$("[name='username'],[name='date_from'],[name='to_date']").change(function(){
      		FindFlag=0;//alert(1);
      	});
      	...
      	$('#search_submit').click(function(){
      		...
      		{      		
      			...
      			$("#trades").dataTable({      				
  					...
  					"bDestroy":true,
  					"bRetrieve":false,
  					"ajax":"queryOperatorLog/queryALL",
  	  	    		"columns":[
  	  	    			{ "data": "date" },
  	  	    			{ "data": "time" },
  	  	    			{ "data": "type" },
      			...
      			$("#trades").dataTable({      					
      				...
      				"serverSide":true,
      				"ajax":{
      					"url":"queryOperatorLog/queryBY",
      					"type":"POST",
      					"data":{username:username,from:from,to:to}
      				},
      				"columns": [
      					{ "data": "date" },
  	  	    			{ "data": "time" },
