...
<div class="row-fluid">
    ...
    <div class="block-flat ">
    	...
    	<table class="table table-hover  table-bordered table-condensed display" id="blacklist">
    		<thead>
    		<tr>
    			<th>序号</th>
    			<th>卡号</th>
    		...
    		<tbody>
    		<c:forEach items="${blackList}" var="value" varStatus="counter">
    			<tr>
    				<td>${counter.count}</td>
