  ...
  (function($, window) {
    ...
    BootstrapSwitch = (function() {
      ...
      function BootstrapSwitch(element, options) {
        ...
        /*This was the hell for me*/
         this.$wrapper.addClass(this.options.baseClass + "-onclr-" + this.options.onColor);
         this.$wrapper.addClass(this.options.baseClass + "-offclr-" + this.options.offColor);
